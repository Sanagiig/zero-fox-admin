...
type ISysUserDo interface {
	...
	GetByRoles(rolesName []string) (result []*model.SysUser, err error)
...
func (s sysUserDo) GetByRoles(rolesName []string) (result []*model.SysUser, err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, rolesName)
	generateSQL.WriteString("SELECT * FROM sys_user WHERE role IN ? ")
...
func (s sysUserDo) InsertValue(name string, age int) (err error) {
	var params []interface{}

	var generateSQL strings.Builder
	params = append(params, name)
	params = append(params, age)
	generateSQL.WriteString("INSERT INTO sys_user (name, age) VALUES (?, ?) ")
