...
type SysUser struct {
	...
	NickName   string     `gorm:"column:nick_name;not null;comment:昵称" json:"nickName"`                                 // 昵称
	...
	UserStatus int32      `gorm:"column:user_status;not null;comment:状态  0：禁用   1：正常" json:"userStatus"`                // 状态  0：禁用   1：正常
	DeptID     int64      `gorm:"column:dept_id;not null;comment:部门id" json:"deptId"`                                   // 部门id
	JobID      int64      `gorm:"column:job_id;not null;comment:岗位id" json:"jobId"`                                     // 岗位id
