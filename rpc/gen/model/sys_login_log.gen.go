...
type SysLoginLog struct {
	...
	LoginStatus string    `gorm:"column:login_status;not null;comment:登录状态" json:"loginStatus"`                       // 登录状态
	IPAddress   string    `gorm:"column:ip_address;not null;comment:IP地址" json:"ipAddress"`                           // IP地址
	...
	ErrorMsg    string    `gorm:"column:error_msg;not null;comment:登录失败信息" json:"errorMsg"`                           // 登录失败信息
	LoginTime   time.Time `gorm:"column:login_time;not null;default:CURRENT_TIMESTAMP;comment:登录时间" json:"loginTime"` // 登录时间
}
