...
type SysPost struct {
	...
	PostStatus int32      `gorm:"column:post_status;not null;default:1;comment:岗位状态" json:"postStatus"`                 // 岗位状态
	PostSort   int32      `gorm:"column:post_sort;not null;comment:岗位排序" json:"postSort"`                               // 岗位排序
