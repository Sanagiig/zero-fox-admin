...
type SysDept struct {
	...
	DeptStatus int32      `gorm:"column:dept_status;not null;default:1;comment:部门状态" json:"deptStatus"`                 // 部门状态
	DeptSort   int32      `gorm:"column:dept_sort;not null;comment:部门排序" json:"deptSort"`                               // 部门排序
	ParentID   int64      `gorm:"column:parent_id;not null;comment:上级机构ID，一级机构为0" json:"parentId"`                      // 上级机构ID，一级机构为0
	...
	ParentIds  string     `gorm:"column:parent_ids;not null;comment:上级机构IDs，一级机构为0" json:"parentIds"`                   // 上级机构IDs，一级机构为0
